...
#include <utility>
#include <numeric>
#include <cstring> // 문자열 길이 계산을 위해 추가
...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock()
{
    ...
    // [수정 지점] OP_0 대신 BITEVER_SCRIPTSIG_MSG 마커를 삽입합니다.
    coinbaseTx.vin[0].scriptSig = CScript() << nHeight << std::vector<unsigned char>(BITEVER_SCRIPTSIG_MSG, BITEVER_SCRIPTSIG_MSG + strlen(BITEVER_SCRIPTSIG_MSG));
